...
Devolvé ÚNICAMENTE un objeto JSON con dos propiedades, sin formatos Markdown ni bloques de código:
{
  ...
  "ai_opening": "La frase de apertura que dice tu personaje en inglés para iniciar el juego"
    ...
    if (action === 'evaluate_voice') {
      const prompt = `Contexto del rol: ${systemInfo || ''}. Frase del personaje AI: "${currentPrompt || ''}".
